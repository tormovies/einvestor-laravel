...
<div class="content">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" style="max-width: 800px; margin-top: 2rem;">
        @csrf
        ...
        <div style="display: grid; gap: 1.5rem;">
            ...
            <div>
                ...
                <textarea name="short_description" rows="3"
                          style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 4px;">{{ old('short_description') }}</textarea>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                ...
                <div>
                    ...
                    <select name="stock_status" required style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 4px;">
                        <option value="in_stock" {{ old('stock_status') === 'in_stock' ? 'selected' : '' }}>В наличии</option>
                        <option value="out_of_stock" {{ old('stock_status') === 'out_of_stock' ? 'selected' : '' }}>Нет в наличии</option>
                    </select>
            ...
            <div>
                ...
                <input type="file" name="file" accept=".zip,.rar,.exe,.dll,.mq4,.mq5"
                       style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 4px;">
                <span style="font-size: 0.875rem; color: #6b7280;">Максимум 10MB</span>
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                <button type="submit" class="btn">Создать товар</button>
