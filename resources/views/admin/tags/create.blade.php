...
@section('title', 'Создать тег - Админ-панель - EInvestor')
...
<div class="content">
    ...
    <form action="{{ route('admin.tags.store') }}" method="POST" style="max-width: 800px; margin-top: 2rem;">
        @csrf
        ...
        <div style="display: grid; gap: 1.5rem;">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                <button type="submit" class="btn">Создать тег</button>
