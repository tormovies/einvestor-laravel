...
<div class="content">
    ...
    <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="post-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width" style="margin-top: 2rem; padding-top: 2rem; border-top: 2px solid #e5e7eb;">
                ...
                <div class="files-section">
                    <strong style="display: block; margin-bottom: 0.5rem;">
                        Загруженные файлы ({{ $post->files->sum('download_count') }} скачиваний всего):
                    </strong>
                        ...
                        <div class="file-item">
                            <div style="flex: 1;">
                                ...
                                <span style="color: #6b7280; font-size: 0.875rem; margin-left: 0.5rem;">
                                    | Скачиваний: <strong>{{ $file->download_count }}</strong>
                                </span>
                            </div>
                ...
                <div class="form-group">
                    <label for="files">Загрузить новые файлы</label>
            ...
            <div class="form-group full-width">
                ...
                <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $post->seo_title) }}" maxlength="255">
            ...
            <div class="form-group full-width">
                ...
                <textarea name="seo_description" id="seo_description" rows="3" maxlength="320">{{ old('seo_description', $post->seo_description) }}</textarea>
            ...
            <div class="form-group full-width">
                ...
                <input type="text" name="seo_h1" id="seo_h1" value="{{ old('seo_h1', $post->seo_h1) }}" maxlength="255">
            ...
            <div class="form-group full-width">
                ...
                <textarea name="seo_intro_text" id="seo_intro_text" rows="3">{{ old('seo_intro_text', $post->seo_intro_text) }}</textarea>
